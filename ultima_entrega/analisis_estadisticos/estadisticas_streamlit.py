...
if __name__ == "__main__":
    ruta_csv = os.path.join(os.path.dirname(constante.ROOT_PATH),"archivos",'perfiles.csv')
    ruta_json = os.path.join(os.path.dirname(constante.ROOT_PATH),"archivos",'perfiles.json')
    try:
